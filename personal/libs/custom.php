...
if(!function_exists('school_types')){
    function school_types(){
        return array(
            'ql' => __("Quốc lập", SHORT_NAME),
            'tl' => __("Tư lập", SHORT_NAME),
        );
    }
}
if(!function_exists('time_enrollment_list')){
    function time_enrollment_list(){
        return array(
            '4' => __('Tháng 4', SHORT_NAME),
            '10' => __('Tháng 10', SHORT_NAME),
            'other' => __('Khác', SHORT_NAME),
        );
    }
}
if(!function_exists('japanese_exams_eju_list')){
    function japanese_exams_eju_list(){
        return array(
            'necessary' => __('Cần thiết', SHORT_NAME),
            'unnecessary' => __('Không cần thiết', SHORT_NAME),
        );
    }
}
if(!function_exists('english_exams_list')){
    function english_exams_list(){
        return array(
            'optional' => __('Không bắt buộc', SHORT_NAME),
            'compulsory' => __('Dự kỳ thi bắt buộc của trường', SHORT_NAME),
            'achievement_of_toefl' => __('Sử dụng thành tích Toefl', SHORT_NAME),
        );
    }
}
if(!function_exists('learning_language_list')){
    function learning_language_list(){
        return array(
            'en' => __('Tiếng Anh', SHORT_NAME),
            'jp' => __('Tiếng Nhật', SHORT_NAME),
        );
    }
}
if(!function_exists('form_of_exam_list')){
    function form_of_exam_list(){
        return array(
            'contest_in_jp' => __('Nộp đơn trực tiếp từ nước ngoài và đến Nhật dự thi', SHORT_NAME),
            'no_contest_in_jp' => __('Nộp đơn trực tiếp từ nước ngoài và không cần đến Nhật dự thi', SHORT_NAME),
        );
    }
}
if(!function_exists('scholarships_list')){
    function scholarships_list(){
        return array(
            'yes' => __('Hỗ trợ học bổng', SHORT_NAME),
            'no' => __('Không hỗ trợ học bổng', SHORT_NAME),
        );
    }
}
